...
GUI.currentsong=currentsong;var currentalbumstring=currentartist+' - '+currentalbum;if(GUI.old_state!==GUI.state||GUI.currentalbum!==currentalbumstring){GUI.old_state=GUI.state;$('#artist-bio-ss').html('');$('#artist-image-ss').css('background-image','');$('#addinfo-text-ss').html('');$('#artist-bio-overlay').html('');$('#artist-image-overlay').css('background-image','');$('#addinfo-text-overlay').html('');var covercachenum=Math.floor(Math.random()*1001);$('#cover-art').css('background-image','url("/coverart/?v='+covercachenum+'")');$('#cover-art-ss').css('background-image','url("/coverart/?v='+covercachenum+'")');$('#cover-art-sss').css('background-image','url("/coverart/?v='+covercachenum+'")');$.ajax({url:'/artist_info/',success:function(data){var info=jQuery.parseJSON(data);if(typeof info.artist!=='undefined'&&info.artist.bio.content!==''){$('#artist-bio-ss').html(info.artist.bio.content.substring(0,Math.min(info.artist.bio.content.indexOf("<a href"),550))+'... ');$('#artist-bio-overlay').html(info.artist.bio.summary.replace('">Read more on Last.fm','/+wiki" target="_blank" rel="nofollow">Read more on Last.fm'));$('#artist-bio-full-overlay').html(info.artist.bio.content);}else{$('#artist-bio-ss').html(currentartist+', sorry, no details available ');$('#artist-bio-overlay').html(currentartist+', sorry, no details available ');$('#artist-bio-full-overlay').html(currentartist+', sorry, no details available ');}
