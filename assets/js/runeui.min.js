...
if(idleTime>SStime){$('#section-index').addClass('disable-scrollbar-1');$('#section-index').addClass('disable-scrollbar-2');$('.tab-content').hide("slow");if((smallScreenSaver)&&(isLocalHost)){$('.small-screen-saver-content').show("slow");}else{$('.screen-saver-content').show("slow");}
