...
function updateGUI(){var volume=GUI.json.volume;var radioname=GUI.json.radioname;var currentartist=GUI.json.currentartist;var currentsong=((typeof GUI.json.currentsong=='undefined')?'':GUI.json.currentsong);var currentalbum=GUI.json.currentalbum;var currentalbumartist=((typeof GUI.json.currentalbumartist=='undefined')?'':GUI.json.currentalbumartist);var currentcomposer=((typeof GUI.json.currentcomposer=='undefined')?'':GUI.json.currentcomposer);var radioname=((typeof GUI.json.radioname=='undefined')?'':GUI.json.radioname);var mainArtURL=((typeof GUI.json.mainArtURL=='undefined')?'':GUI.json.mainArtURL);var bigArtURL=((typeof GUI.json.bigArtURL=='undefined')?'':GUI.json.bigArtURL);var smallArtURL=((typeof GUI.json.smallArtURL=='undefined')?'':GUI.json.smallArtURL);var song_lyrics=((typeof GUI.json.song_lyrics=='undefined')?'':GUI.json.song_lyrics);var artist_bio_summary=((typeof GUI.json.artist_bio_summary=='undefined')?'':GUI.json.artist_bio_summary);var artist_similar=((typeof GUI.json.artist_similar=='undefined')?'':GUI.json.artist_similar);GUI.stream=((radioname!==null&&radioname!==undefined&&radioname!=='')?'radio':'');refreshState();if($('#section-index').length){if(GUI.currentsong!==GUI.json.currentsong){countdownRestart(0);if($('#panel-dx').hasClass('active')){var current=parseInt(GUI.json.song);customScroll('pl',current);}}
if(GUI.vol_changed_local===0){$('#volume').val((volume==='-1')?100:volume,false).trigger('update');}
if(currentartist===null||currentartist.length>55){$('#currentartist-ss')[0].style.fontSize="18px";$('#currentartist-sss')[0].style.fontSize="28px";}else if(currentartist.length>45){$('#currentartist-ss')[0].style.fontSize="20px";$('#currentartist-sss')[0].style.fontSize="30px";}else if(currentartist.length>30){$('#currentartist-ss')[0].style.fontSize="22px";$('#currentartist-sss')[0].style.fontSize="32px";}else{$('#currentartist-ss')[0].style.fontSize="28px";$('#currentartist-sss')[0].style.fontSize="34px";}
$('#currentartist').html((currentartist===null||currentartist===undefined||currentartist==='')?'<span class="notag">[no artist]</span>':currentartist);$('#currentartist-ss').html((currentartist===null||currentartist===undefined||currentartist==='')?'<span class="notag">[no artist]</span>':currentartist);$('#currentartist-sss').html((currentartist===null||currentartist===undefined||currentartist==='')?'<span class="notag">[no artist]</span>':currentartist);if(currentsong===null||currentsong.length>55){$('#currentsong-ss')[0].style.fontSize="18px";$('#currentsong-sss')[0].style.fontSize="28px";}else if(currentsong.length>45){$('#currentsong-ss')[0].style.fontSize="20px";$('#currentsong-sss')[0].style.fontSize="30px";}else if(currentsong.length>35){$('#currentsong-ss')[0].style.fontSize="26px";$('#currentsong-sss')[0].style.fontSize="32px";}else if(currentsong.length>25){$('#currentsong-ss')[0].style.fontSize="32px";$('#currentsong-sss')[0].style.fontSize="36px";}else{$('#currentsong-ss')[0].style.fontSize="40px";$('#currentsong-sss')[0].style.fontSize="40px";}
$('#currentsong').html((currentsong===null||currentsong===undefined||currentsong==='')?'<span class="notag">[no title]</span>':currentsong);$('#currentsong-ss').html((currentsong===null||currentsong===undefined||currentsong==='')?'<span class="notag">[no title]</span>':currentsong);$('#currentsong-sss').html((currentsong===null||currentsong===undefined||currentsong==='')?'<span class="notag">[no title]</span>':currentsong);if(currentalbum===null||currentalbum.length>55){$('#currentalbum-ss')[0].style.fontSize="18px";$('#currentalbum-sss')[0].style.fontSize="28px";}else if(currentalbum.length>45){$('#currentalbum-ss')[0].style.fontSize="20px";$('#currentalbum-sss')[0].style.fontSize="30px";}else if(currentalbum.length>30){$('#currentalbum-ss')[0].style.fontSize="22px";$('#currentalbum-sss')[0].style.fontSize="32px";}else{$('#currentalbum-ss')[0].style.fontSize="24px";$('#currentalbum-sss')[0].style.fontSize="34px";}
...
if(GUI.currentsong!==currentsong){$('#lyric-text-overlay').html('');if(GUI.stream!=='radio'){$.ajax({url:'/lyric/',success:function(data){$('#lyric-text-overlay').html(data);},cache:false});}else{$('#lyric-text-overlay').html(song_lyrics);}}
GUI.currentsong=currentsong;var currentalbumstring=currentartist+' - '+currentalbum;if(GUI.old_state!==GUI.state||GUI.currentalbum!==currentalbumstring){GUI.old_state=GUI.state;if(GUI.stream==='radio'){$('#artist-bio-ss').html(artist_bio_summary);$('#artist-bio-overlay').html(artist_bio_summary);$('#addinfo-text-ss').html(artist_similar);$('#addinfo-text-overlay').html(artist_similar);$('#artist-image-ss').css('background-image','url("'+smallArtURL+'")');$('#artist-image-overlay').css('background-image','url("'+smallArtURL+'")');$('#cover-art').css('background-image','url("'+mainArtURL+'")');$('#cover-art-ss').css('background-image','url("'+bigArtURL+'")');$('#cover-art-sss').css('background-image','url("'+mainArtURL+'")');}else{$('#artist-bio-ss').html('');$('#artist-image-ss').css('background-image','');$('#addinfo-text-ss').html('');$('#artist-bio-overlay').html('');$('#artist-image-overlay').css('background-image','');$('#addinfo-text-overlay').html('');var covercachenum=Math.floor(Math.random()*1001);$('#cover-art').css('background-image','url("/coverart/?v='+covercachenum+'")');$('#cover-art-ss').css('background-image','url("/coverart/?v='+covercachenum+'")');$('#cover-art-sss').css('background-image','url("/coverart/?v='+covercachenum+'")');$.ajax({url:'/artist_info/',success:function(data){var info=jQuery.parseJSON(data);if(typeof info.artist!=='undefined'&&info.content!==''){$('#artist-bio-ss').html(info.content.substring(0,Math.min(info.artist.bio.content.indexOf("<a href"),550))+'... ');$('#artist-bio-overlay').html(info.summary);$('#artist-bio-full-overlay').html(info.content);}
if(typeof info.artist!=='undefined'&&info.similar!==''){$('#addinfo-text-ss').html(info.similar);$('#addinfo-text-overlay').html(info.similar);}else{$('#addinfo-text-ss').html('');$('#addinfo-text-overlay').html('');}},cache:false});}}
...
if(inputArr.file!==undefined||inpath==='Webradio'){content='<li id="db-'+(i+1)+'" data-path="';if(inputArr.fileext===undefined){if(inputArr.file!==undefined){inputArr.fileext=inputArr.file.split(".").pop().toLowerCase();}else{inputArr.fileext='';}}else{inputArr.fileext=inputArr.fileext.toLowerCase();}
if(inputArr.Title!==undefined){content+=inputArr.file;content+='"><i class="fa fa-bars db-action" title="Actions" data-toggle="context" data-target="#context-menu-file"></i><i class="fa fa-music db-icon"></i><span class="sn">';content+=inputArr.Title+' <span>'+timeConvert(inputArr.Time)+' <span>'+inputArr.fileext+'</span></span>';content+=' <span class="bl">';content+=inputArr.Artist;content+=' - ';content+=inputArr.Album;}else{if(inpath!=='Webradio'){content+=inputArr.file;content+='"><i class="fa fa-bars db-action" title="Actions" data-toggle="context" data-target="#context-menu-file"></i><i class="fa fa-music db-icon"></i><span class="sn">';content+=inputArr.file.replace(inpath+'/','')+' <span>'+timeConvert(inputArr.Time)+' <span>'+inputArr.fileext+'</span></span>';content+='<span class="bl">';content+=' path: ';content+=inpath;}else{content+=inputArr.playlist;content+='"><i class="fa fa-bars db-action" title="Actions" data-toggle="context" data-target="#context-menu-webradio"></i><i class="fa fa-microphone db-icon db-radio"></i>';content+='<span class="sn">'+inputArr.playlist.replace(inpath+'/','').replace('.'+inputArr.fileext,'');content+='</span><span class="bl">webradio';}}
...
if($('#section-mpd').length){$('#audio-output-interface').change(function(){renderMSG([{'title':'Switching audio output','text':'Please wait for the config update...','icon':'fa fa-cog fa-spin','delay':5000}]);var output=$(this).val();$.ajax({type:'POST',url:'/mpd/',data:{ao:output},cache:false});});$('.manual-edit-confirm').find('.btn-primary').click(function(){$('#mpdconf_editor').removeClass('hide');$('#manual-edit-warning').addClass('hide');});$('#mpd-gr-cb').change(function(){if($(this).prop('checked')){$('#mpd-gr-fields').removeClass('hide');}else{$('#mpd-gr-fields').addClass('hide');}});}
if($('#section-debug').length){$('#copyText').click(function(){$('#text2copy').removeClass('hide');$('#text2copy').select();document.execCommand("copy");$('#text2copy').addClass('hide');new PNotify({title:'Copied to clipboard',text:'The debug output was copied successfully in your clipboard.',icon:'fa fa-check'});});}
