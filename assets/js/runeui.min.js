...
GUI.currentsong=currentsong;var currentalbumstring=currentartist+' - '+currentalbum;if(GUI.old_state!==GUI.state||GUI.currentalbum!==currentalbumstring){GUI.old_state=GUI.state;$('#artist-bio-ss').html('');$('#artist-image-ss').css('background-image','');$('#addinfo-text-ss').html('');$('#artist-bio-overlay').html('');$('#artist-image-overlay').css('background-image','');$('#addinfo-text-overlay').html('');$('#lyric-text-overlay').html('');if(GUI.stream!=='radio'){var covercachenum=Math.floor(Math.random()*1001);$('#cover-art').css('background-image','url("/coverart/?v='+covercachenum+'")');$('#cover-art-ss').css('background-image','url("/coverart/?v='+covercachenum+'")');$.ajax({url:'/artist_info/',success:function(data){var info=jQuery.parseJSON(data);if(typeof info.artist!=='undefined'&&info.artist.bio.content!==''){$('#artist-bio-ss').html(info.artist.bio.content.substring(0,550)+' ... ');$('#artist-bio-overlay').html(info.artist.bio.summary);$('#artist-bio-full-overlay').html(info.artist.bio.content);$('#addinfo-text-ss').html('Similar Artists:<br>&nbsp;&nbsp;&nbsp;&nbsp;'+info.artist.similar.artist[0].name+'<br>&nbsp;&nbsp;&nbsp;&nbsp;'+info.artist.similar.artist[1].name+'<br>&nbsp;&nbsp;&nbsp;&nbsp;'+info.artist.similar.artist[2].name+'<br>&nbsp;&nbsp;&nbsp;&nbsp;'+info.artist.similar.artist[3].name+'<br>&nbsp;&nbsp;&nbsp;&nbsp;'+info.artist.similar.artist[4].name);$('#addinfo-text-overlay').html('Similar Artists:<br>&nbsp;&nbsp;&nbsp;&nbsp;'+info.artist.similar.artist[0].name+'<br>&nbsp;&nbsp;&nbsp;&nbsp;'+info.artist.similar.artist[1].name+'<br>&nbsp;&nbsp;&nbsp;&nbsp;'+info.artist.similar.artist[2].name+'<br>&nbsp;&nbsp;&nbsp;&nbsp;'+info.artist.similar.artist[3].name+'<br>&nbsp;&nbsp;&nbsp;&nbsp;'+info.artist.similar.artist[4].name+'<br>&nbsp;<br>&nbsp;');$('#artist-image-ss').css('background-image','url("'+info.artist.image[2]["#text"]+'")');$('#artist-image-overlay').css('background-image','url("'+info.artist.image[2]["#text"]+'")');}else{$('#artist-bio-ss').html(' sorry, no info available ');$('#artist-bio-overlay').html(' sorry, no info available ');$('#addinfo-text-ss').html('');$('#addinfo-text-overlay').html('');$('#lyric-text-overlay').html('');$('#artist-image-ss').css('background-image','url("assets/img/unkown.png")');$('#artist-image-overlay').css('background-image','url("assets/img/unkown.png")');}},cache:false});$.ajax({url:'/lyric/',success:function(data){$('#lyric-text-overlay').html(data);},cache:false});}else{var covercachenum=Math.floor(Math.random()*1001);$.ajax({url:'/artist_info/',success:function(data){var info=jQuery.parseJSON(data);if(typeof info.artist!=='undefined'&&info.artist.bio.content!==''){$('#artist-bio-ss').html(info.artist.bio.content.substring(0,1000)+' ... ');$('#addinfo-text-ss').html('Similar Artists:<br>&nbsp;&nbsp;&nbsp;&nbsp;'+info.artist.similar.artist[0].name+'<br>&nbsp;&nbsp;&nbsp;&nbsp;'+info.artist.similar.artist[1].name+'<br>&nbsp;&nbsp;&nbsp;&nbsp;'+info.artist.similar.artist[2].name+'<br>&nbsp;&nbsp;&nbsp;&nbsp;'+info.artist.similar.artist[3].name+'<br>&nbsp;&nbsp;&nbsp;&nbsp;'+info.artist.similar.artist[4].name);$('#artist-image-ss').css('background-image','url("'+info.artist.image[2]["#text"]+'")');}},cache:false});$('#cover-art').css('background-image','url("assets/img/cover-radio.jpg")');$('#cover-art-ss').css('background-image','url("assets/img/cover-radio.jpg")');}}
