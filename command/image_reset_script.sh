...
declare -a enable_arr=(avahi-daemon haveged nginx redis rune_SY_wrk sshd systemd-journald systemd-timesyncd dbus iwd connman connman-wait-online bluetooth bluealsa bluealsa-aplay amixer-webui)
