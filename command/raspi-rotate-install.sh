...
cp /var/www/app/config/defaults/99-raspi-rotate.conf.tmpl /home/raspi-rotate/99-raspi-rotate.conf.tmpl
...
cp /home/raspi-rotate/99-raspi-rotate.conf.tmpl /var/www/app/config/defaults/99-raspi-rotate.conf.tmpl
