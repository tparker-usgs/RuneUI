    ...
    <form class="form-horizontal" action="/sources/" method="post" role="form" data-parsley-validate>
        ...
        <fieldset id="mount-advanced-config" class="hide">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control osk-trigger input-lg" type="text" id="nas-rsize" name="mount[rsize]" value="<?=$this->mount['rsize']?>" data-trigger="change" autocomplete="off" placeholder="8192">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control osk-trigger input-lg" type="text" id="nas-wsize" name="mount[wsize]" value="<?=$this->mount['wsize']?>" data-trigger="change" autocomplete="off" placeholder="16384">
                    <span class="help-block">Change this settings if you experience problems with music playback (es: pops or clips)</span>
                </div>
            </div>
            <div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control osk-trigger input-lg" type="text" id="options" name="mount[options]" value="<?=$this->mount['options']?>" data-trigger="change" autocomplete="off" placeholder="cache=none,noserverino,ro,vers=1.0">
